...
interface ModalProdutoEstoqueProdutoDeleteComponentProps {
    open: boolean
    setOpen: any
...
export default function ModalProdutoEstoqueProdutoDeleteComponent({
    open,
    setOpen,
    deletarProdutoEstoqueUseCase,
    buscarProdutoUseCase,
    idEstoque
}: ModalProdutoEstoqueProdutoDeleteComponentProps) {
    ...
    async function onCreate(event: any) {
        try {
            ...
            const idProduto = event.target[0].value
